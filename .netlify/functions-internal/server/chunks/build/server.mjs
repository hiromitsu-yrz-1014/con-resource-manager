...
import { v as parseURL, f as encodePath, d as decodePath, o as hasProtocol, p as isScriptProtocol, s as joinURL, B as withQuery, w as sanitizeStatusCode, h as getContext, $ as $fetch, c as createError$1, g as executeAsync, i as getHeader, x as setCookie, y as setHeader, b as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B_AK9MbW.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CkbQz4tM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DH-9zYbd.mjs'));
